...
- P2: Add smoke assertion coverage for diagnostics invariants (`loaded >= matched >= visible`) via browser-executed route checks.
- P3: Add dead-code sweep for legacy saved-search key paths in Library and unify migration helpers.
