...
- P1: Add saved-search smoke roundtrip assertions (save, reload, rerun with persisted filter/sort/timeline/verbatim) under mock mode.
- P1: Add query-result parity tests proving top-k UI ordering matches full export ordering on tie scores and invalid timestamps.
