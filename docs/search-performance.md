...
- Uses `tests/search-perf.bench.ts` with deterministic synthetic datasets generated by `createDeterministicUnifiedSearchDataset()`.
...
| --- | --- | --- | --- | --- |
| 1,000 | 0.49 ms | 0.82 ms | 0.55 ms | 0.82 ms |
| 5,000 | 2.26 ms | 2.71 ms | 2.30 ms | 2.71 ms |
| 10,000 | 4.48 ms | 5.05 ms | 4.54 ms | 5.05 ms |
