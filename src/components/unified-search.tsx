      ...
      <main className="px-6 py-10">
        <div className="max-w-3xl space-y-3">
          <input
            ...
            placeholder='Search threads, spaces, collections, files, and tasks (try: type:threads mode:research source:web is:pinned has:note tag:foo space:"Research" verbatim:true)'
